...
const ImageLinkForm = ({onInputChange,onInputFocus,onInputBlur, onButtonSubmit ,input, handleKeyUp}) => {
	return (
		<div className ='ma4 mt0'>
			...
			<div className='center'>
				<div 
					className='bg-black-10 br2 ba b--black-10 form center pa4 shadow-5'>
					<input 
